...
@Component({
  ...
  templateUrl: './elephant.page.html',
  styleUrls: ['./elephant.page.scss'],
})
export class ElephantPage implements OnInit {

  @ViewChild('swiperSlideShow') swiperSlideShow: SwiperComponent;

  public imagesSlides = [
    '../../assets/img/elephant/terraza.webp',
    '../../assets/img/elephant/patio.webp',
    '../../assets/img/elephant/recamara.webp',
    '../../assets/img/elephant/cocina.jpeg',
    '../../assets/img/elephant/sala.jpeg',
    '../../assets/img/elephant/patio.jpeg',
    //'../../assets/img/elephant/cocina.webp',
  ...
  public loveMessage: string = "Hola Mariela, me interesa el Bungalow Elefante, me podrías proporcionar más información";
